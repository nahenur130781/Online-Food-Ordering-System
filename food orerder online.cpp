	...
	if(choice==1)
	 {
		...
		if(pchoice>=1 && pchoice<=5)
		{
			...
			case 2: choice = 590*quantity;
			break;

			case 3: choice = 1000*quantity;
			break;
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\nYour Total Bill is"<<choice<<"\nYour Order Will be delivered in 60 Minutes";
			 cout<<"\nThank you For Ordering From Friend's Fast Food\n";
			 break;
			 case 4:
			 cout<<"\t\t--------Your Order---------\n";
	 ...
	 else if(choice==2)
	 {
		...
		if(pchoice1>=1 && pchoice1<=3)
		{
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\t\t--------Your Order---------\n";
			 cout<<""<<quantity<<" "<<bur3;
			 cout<<"\nYour Total Bill is"<<choice<<"\nYour Order Will be delivered in 80 Minutes";
			 cout<<"\nThank you For Ordering From Friend's Fast Food\n";
			 break;
	...
	else if(choice==5)
	 {
		...
		if(pchoice1>=1 && pchoice1<=3)
		{
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\t\t--------Your Order---------\n";
			 cout<<""<<quantity<<" "<<bir1;
			 cout<<"\nYour Total Bill is"<<choice<<"\nYour Order Will be delivered in 42 Minutes";
			 cout<<"\nThank you For Ordering From Friend's Fast Food \n";
			 break;
			 case 2:
			 cout<<"\t\t--------Your Order---------\n";
